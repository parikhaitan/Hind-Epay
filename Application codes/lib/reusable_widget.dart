...
Container reusableContainerButton(double h, double w, double fh, double fw, Image im, String t){
  return Container(
      height: (fh) * h,
      width: fw * w,
      child: Column(
...
AppBar reusableAppBarBG(double w, String title, BuildContext context){
  return AppBar(
    flexibleSpace: Image(
    ...
    //Image.asset('Assets/Images/Hind e-pay logo.png',width: 0.3*w,fit: BoxFit.fitWidth),
    title:
    Text(title,
      style: TextStyle(
          fontSize: 30,
          color: Colors.black,
          fontWeight: FontWeight.bold, fontFamily: 'BebasNeue'),),
    //   centerTitle: true,
    toolbarHeight: 90.2,
    toolbarOpacity: 0.8,
...
Container ReusableTextFieldWithTitle(BuildContext context, String title, TextEditingController textEditingController, String hintText){
  return Container(
...
AppBar reusableAppBar(double w, String title, BuildContext context){
  return AppBar(
    ...
    IconButton( onPressed: (){
      Navigator.pop(context);
    },icon:Icon(Icons.arrow_back_ios,size: 20,color: Colors.black,)),      title:
       Text(title,
        style: TextStyle(
            fontSize: 30,
            color: Colors.black,
...
AppBar reusableAppBarOpp(double w, String title, BuildContext context){
  return AppBar(
    ...
    IconButton( onPressed: (){
      Navigator.pop(context);
    },icon:Icon(Icons.arrow_back_ios,size: 20,color: Colors.white,)),    title:
    Text(title,
      style: TextStyle(
          fontSize: 30,
          color: Colors.white,
